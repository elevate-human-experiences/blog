...
<CardGroup cols={2}>
  <Card title="Share on LinkedIn" href="https://www.linkedin.com/sharing/share-offsite/?url=https://blog.elevate.do/a2a/deep-research/a2a" icon="linkedin">
    Share this article with your network
  </Card>
  <Card title="Share on X" href="https://twitter.com/intent/tweet?url=https://blog.elevate.do/a2a/deep-research/a2a&text=Understanding Google's A2A protocol: the lingua franca for autonomous agent collaboration in enterprise environments" icon="twitter">
