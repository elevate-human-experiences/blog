...
Note:
- If the seed data to you is Deep Research using Claude/ChatGPT then your description should include that (e.g. "Deep Research using GPT-5, by Rahul Parundekar. Published on 17th April, 2025." ).
