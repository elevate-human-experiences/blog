...
<CardGroup cols={2}>
  <Card title="Share on LinkedIn" href="https://www.linkedin.com/sharing/share-offsite/?url=https://blog.elevate.do/k8s/troubleshooting_kubernetes_with_k8x" icon="linkedin">
    Share this article with your network
  </Card>
  <Card title="Share on X" href="https://twitter.com/intent/tweet?url=https://blog.elevate.do/k8s/troubleshooting_kubernetes_with_k8x&text=k8x: Autonomous Kubernetes troubleshooting with GenAI agents - from suggestion to orchestrated multi-step diagnostics" icon="twitter">
