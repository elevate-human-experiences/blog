...
<CardGroup cols={2}>
  <Card title="Share on LinkedIn" href="https://www.linkedin.com/sharing/share-offsite/?url=https://blog.elevate.do/ai-workplace/deep-research/vibe-coding" icon="linkedin">
    Share this article with your network
  </Card>
  <Card title="Share on X" href="https://twitter.com/intent/tweet?url=https://blog.elevate.do/ai-workplace/deep-research/vibe-coding&text=Vibe-checking vibe coding: reality check on the promises, pitfalls, and practical takeaways of AI-powered development" icon="twitter">
